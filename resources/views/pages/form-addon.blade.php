                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Group Add-Ons')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Input Group')}}</h3>
                    </div>
                    <div class="card-body">
                        <div class="mb-20">
                            <h4 class="sub-title">{{ __('Basic Group Add-ons')}}</h4>
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Simple Add-on')}}</label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Placeholder')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Right Add-on')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Both-side Add-on')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text">$</label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Muliple Add-ons')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text">$</label>
                        ...
                        <div>
                            <h4 class="sub-title">{{ __('Icon Group Addons')}}</h4>
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Left Icon')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Right Icon')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Right addon">
                                        <span class="input-group-append">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Both-side Icons Addon')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Input Group Colors')}}</h3>
                    </div>
                    <div class="card-body">
                        <h4 class="sub-title">{{ __('color Addons')}}</h4>
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Input Group With Components')}}</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-20">
                            <div class="col-sm-12 col-lg-6">
                                <h4 class="sub-title">{{ __('Icon Group with Buttons')}}</h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-button">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-primary" type="button">{{ __('Left Button')}}</button>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-button">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-primary" type="button">{{ __('Right Button')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <h4 class="sub-title">{{ __('Icon Group with Dropdowns')}}</h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-dropdown">
                                            <div class="input-group-prepend">
                                                <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('Left Action')}} <i class="ik ik-chevron-down"></i></button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#!">{{ __('Action')}}</a>
                                                    <a class="dropdown-item" href="#!">{{ __('Another action')}}</a>
                                                    <a class="dropdown-item" href="#!">{{ __('Something else')}}</a>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-dropdown">
                                            <input type="text" class="form-control" aria-label="Text input with dropdown button">
                                            <div class="input-group-append">
                                                <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('Right Action')}} <i class="ik ik-chevron-down"></i></button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#!">{{ __('Action')}}</a>
                                                    <a class="dropdown-item" href="#!">{{ __('Another action')}}</a>
                                                    <a class="dropdown-item" href="#!">{{ __('Something else')}}</a>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-dropdown">
                                            <div class="input-group-btn">
                                                <div class="input-group-prepend">
                                                    <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('Click')}} <i class="ik ik-chevron-down"></i></button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#!">{{ __('Action')}}</a>
                                                        <a class="dropdown-item" href="#!">{{ __('Another action')}}</a>
                                                        <a class="dropdown-item" href="#!">{{ __('Something else')}}</a>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="sub-title">{{ __('Icon Group with Checkbox')}}</h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                            ...
                            <div class="col-sm-6">
                                <h4 class="sub-title">{{ __('Icon Group with Radio')}}</h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Input Group Alignment')}}</h3>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Normal Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-volume"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Bold Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Capitalize Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Uppercase Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-wifi"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Lowercase Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Varient Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-volume"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Left-Align Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-tv"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Center-Align Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-gitlab"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('Right-Align Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-shield"></i></label>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-2 col-form-label">{{ __('RTL Text')}}</label>
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <label class="input-group-text"><i class="ik ik-volume"></i></label>
